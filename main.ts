...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (arbol_tocado) {
        ...
        miniMenu.createMenuItem("Cabra (5 llenya)"),
        miniMenu.createMenuItem("Gallina (6 llenya)"),
        miniMenu.createMenuItem("Patates (2 llenya)"),
        miniMenu.createMenuItem("Dotzena d'ous (3 llenya)"),
        miniMenu.createMenuItem("Caball (12 llenya)"),
...
if (myMenu) {
        ...
        if (selectedIndex == 5) {
            ...
            if (llenya_actual >= costo_total) {
                ...
                game.splash("Cost: " + ("" + costo_total) + "kg llenya")
                controller.moveSprite(nena, 100, 100)
                seleccio_menu = 0
            } else {
                controller.moveSprite(nena, 100, 100)
...
sprites.onDestroyed(SpriteKind.arbre, function (sprite2) {
    llenya_actual += 3
